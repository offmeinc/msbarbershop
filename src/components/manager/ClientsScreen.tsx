      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input 
            ...
            className="w-full bg-white/[0.02] border border-white/10 rounded-full pl-12 pr-4 py-3 text-xs text-white uppercase font-black tracking-widest placeholder:text-neutral-600 outline-none focus:border-amber-500 focus:bg-white/[0.04] transition-all"
          />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <AnimatePresence>
            {filteredClients.length === 0 ? (
              <div className="col-span-full text-center py-20 bg-white/[0.02] rounded-[2.5rem] border border-white/5 space-y-2">
              ...
              filteredClients.map((client, index) => {
                ...
                return (
                  <motion.div 
                    ...
                    className="group relative overflow-hidden bg-white/[0.03] backdrop-blur-md p-5 rounded-[2.5rem] border border-white/10 flex flex-col justify-between hover:border-amber-500/30 hover:bg-white/[0.06] transition-all duration-300 cursor-pointer shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] animate-fade-in"
                  >
                    {/* Visual Card Accents */}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="relative w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center text-neutral-500 font-bold overflow-hidden border border-white/10 shrink-0 group-hover:border-amber-500/30 transition-colors">
                          {client.photoURL ? (
                            <img 
                              src={client.photoURL} 
                              alt={client.name} 
                      ...
                      <div className="space-y-1.5">
                        {client.whatsapp && (
                          <div className="flex items-center justify-between bg-black/40 border border-white/5 py-1.5 pl-3 pr-2.5 rounded-xl">
                        ...
                        <div className="flex flex-col gap-1.5 bg-black/40 border border-white/5 py-2 px-3 rounded-xl">
                        ...
                        <div className="bg-black/40 border border-white/5 py-2 px-3 rounded-xl flex flex-col gap-1 text-left">
                        ...
                        {upcomingApp ? (
                          ...
                          <div className="bg-black/30 border border-white/5 py-2.5 px-3 rounded-xl flex items-center justify-between text-left">
                            <div className="space-y-0.5">
                    ...
                    <div className="flex items-center justify-between gap-2 pt-4 mt-4 border-t border-white/5">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button 
                          ...
                          className="p-2 text-neutral-500 hover:text-white border border-white/5 hover:border-white/20 bg-black/20 hover:bg-black/40 transition-all rounded-xl cursor-pointer"
                        >
