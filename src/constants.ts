...
export const BARBERSHOP_INSTAGRAM = "ms_barbershoprs";
export const GOOGLE_REVIEW_URL = "https://www.google.com/maps/search/?api=1&query=MS+BARBERSHOP+Rua+S%C3%A3o+Pedro+46+Cachoeirinha";
